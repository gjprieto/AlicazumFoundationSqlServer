...
namespace Foundation.UnitTests.Application.Messages.Queries
{
    public class QueryBaseTheories
    {
        [Theory(DisplayName = "QueryBase ValidateAsync Tests")]
        ...
        {
            var msg = new FakeQuery { Input = new FakeInput { Name = name, Value = value } };
